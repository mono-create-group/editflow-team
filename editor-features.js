(function(){
  ...
  const PORTAL_APP_VERSION='20260828-14';
  const feature={
  ...
  function injectStyles(){
    ...
    const style=document.createElement('style');style.id='editor-features-style';style.textContent=`
      ...
      .editor-nav-desktop{position:relative;overflow:visible;flex-wrap:wrap}.editor-nav-more{position:relative}.editor-nav-more summary{list-style:none}.editor-nav-more summary::-webkit-details-marker{display:none}.editor-nav-more-menu{position:absolute;top:calc(100% + 6px);right:0;z-index:90;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;width:min(340px,calc(100vw - 36px));padding:10px;border:1px solid var(--border);border-radius:12px;background:var(--card);box-shadow:0 18px 48px rgba(15,23,42,.18)}.editor-nav-more-menu .btn{width:100%;min-width:0;min-height:44px;justify-content:flex-start;padding:9px 11px;text-align:left;white-space:normal;line-height:1.35}.editor-nav-mobile{display:none}.editor-primary-action{border:2px solid #7c3aed;background:#faf5ff}.editor-primary-action .actions{margin-top:10px}.editor-next-child{display:block;margin-top:4px;font-size:12px;color:#5b21b6;font-weight:750}.editor-case-group>summary>span:first-child{min-width:0}.editor-case-group>summary b,.editor-case-group>summary small{overflow-wrap:anywhere}
