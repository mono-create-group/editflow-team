...
test('manager overdue excludes confirmation and revision statuses', () => {
  ...
  assert.equal(context.check({ deadline: '2026-08-01', status: '先方確認中' }, '2026-08-26'), false);
...
test('editor portal uses the same overdue exclusions', () => {
  ...
  assert.equal(context.check({ deliveryDate: '2026-08-01', status: '先方確認中' }, '2026-08-26'), false);
