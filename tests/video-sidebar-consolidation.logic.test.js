...
test('編集者の主アイコンは編集者管理を開き、旧編集者別集計はその他へ残す',()=>{
  assert.match(html,/const coreKeys=tabs\.some\(\(\[key\]\)=>key==='manager-editors'\)\s*\?\['board','manage-calendar','manage-priority','manage-profit','manage-payment','manage-completed','manager-editors','manager-clients'\]/);
