...
test('owner shell and service worker load the video-lead extension on the same release',()=>{
  ...
  assert.match(index,/const APP_VERSION='20260905-10';/);
  assert.match(index,/<script src="\.\/sales-video-leads\.js\?v=20260905-10"><\/script>/);
  assert.match(sw,/const CACHE='mcshanai-20260905-10';/);
