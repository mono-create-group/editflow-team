...
const CACHE='mcshanai-20260826-12';
const URLS=['./','./index.html','./editor.html','./editor-features.js','./manager-features.js','./manifest.json','./icon-192.png','./ai-bridge-client.js'];
