(function(){
  ...
  function readBoardSubcases(){
    ...
    for(const row of rows){
      ...
      items.push({id:row.dataset.subcaseId||safeId(),title,editorDraftDateSetter,editorDraftDate,clientDraftDate,deliveryDate,instructions,requestUrl,sourceUrl,attachments:attachmentRead.items});
    }
    return{error:'',items};
  }
  ...
  async function publishBoard(){
    ...
    const parentRequestUrl=document.getElementById('mb-parent-request')?.value.trim()||'',parentSourceUrl=document.getElementById('mb-parent-source')?.value.trim()||'';
